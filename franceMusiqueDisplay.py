...
# <bitbar.title>Playlists France Musique WebRadio</bitbar.title>
# <bitbar.version>v1.0</bitbar.version>
# <bitbar.author>Alexis LOUIS</bitbar.author>
# <bitbar.author.github>wimacod</bitbar.author.github>
# <bitbar.desc>Displays last played tracks from 7 possible France Musique webradios</bitbar.desc>
# <bitbar.image>http://imgur.com/a/DCPtg</bitbar.image>
...
for history_indice in range(0,history_max):
    ...
    print '---'
    print titles[history_indice] + "| color=#fd8237 size=13 href=" + url
    print "Interprète : " + performers[history_indice] + "| color=#c0c0c0 size=11"
    if active_radio != la_jazz :
        print "Compositeur : " + composers[history_indice] + "| color=#c0c0c0 size=11"
    print "Album : " + albums[history_indice] + "| color=#c0c0c0 size=11"
    print "Label : " + labels[history_indice] + "| color=#c0c0c0 size=11"
    print "Début : " + date[history_indice] + "| color=#c0c0c0 size=11"
